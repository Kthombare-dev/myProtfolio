...
const items: TimelineItem[] = [
  {
    ...
    bullets: [
      "Building backend features and APIs that power core product flows.",
      "Managing database operations, authentication, and user-facing service logic.",
      "Delivering stable, production-ready updates while collaborating with design and mobile teams.",
    ],
    stack: ["Node.js", "Backend APIs", "Database", "Authentication"],
    category: "experience",
  },
  {
    company: "Emilio Beaufort | Full Stack Developer & Team Lead",

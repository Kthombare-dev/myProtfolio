  ...
  return (
    <section id="systems" className="w-full pt-10 md:pt-14 pb-12 md:pb-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mt-8 sm:mt-10 md:mt-12 px-4 sm:px-6">
          <motion.div
          ...
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-[#D4AF37] to-[#B8941F] hover:from-[#B8941F] hover:to-[#D4AF37] text-black font-semibold py-3 px-4 sm:py-4 sm:px-6 md:py-4 md:px-8 rounded-lg sm:rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#D4AF37]/25 group text-sm sm:text-base md:text-base w-full sm:w-auto max-w-xs sm:max-w-none"
            >
              <svg 
                width="18" 
                height="18" 
                viewBox="0 0 24 24" 
                fill="currentColor" 
                className="group-hover:scale-110 transition-transform duration-200 flex-shrink-0 sm:w-5 sm:h-5"
              >
                <path d="M12 0C5.374 0 0 5.373 0 12 0 17.302 3.438 21.8 8.207 23.387c.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0112 5.803c1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.627-5.373-12-12-12z"/>
              </svg>
